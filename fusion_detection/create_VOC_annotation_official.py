...
def format_label(mode, txt_list):
    ...
    # return bbox_left, bbox_top, bbox_right, bbox_bottom, class_id
...
def parse_args():
    ...
    parser.add_argument('--root_dir', default="/home/zzg/zgzheng/datasets/VisDrone",
    ...
    parser.add_argument('--output_folder', default='create_voc',help='The dir to save generated images and annotations')
...
if __name__ == "__main__":
    ...
    mode = args.mode
    root_dir = args.root_dir # /home/zzg/zgzheng/datasets/VisDrone
    crop_name = args.output_folder # create_voc
    affix = args.image_prefix # jpg
    ...
    raw_label_dir = os.path.join(root_dir, 'annotations', mode)
    ...
    img_affix = affix # jpg
    images = [i for i in os.listdir(raw_images_dir) if img_affix in i] # [xxx.jpg, xxx.jpg]
    labels = [i for i in os.listdir(raw_label_dir) if 'txt' in i] # [xxx.txt, xxx.txt]
