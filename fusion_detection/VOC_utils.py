...
# 0000002_00005_d_0000014, create_voc/mode
def annotation2xml(file_idx, save_dir, image, boxes_all, class_list):
    ...
    :return:
    """
    xml_path = os.path.join(save_dir, 'annotations',
                       "%s.xml" % (file_idx))
    save_to_xml(xml_path, file_idx, image.shape[0], image.shape[1], boxes_all, class_list)
